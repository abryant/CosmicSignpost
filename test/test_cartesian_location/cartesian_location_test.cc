...
TEST(CartesianLocation, DirectionTowardsAbove_AtNorthPole) {
  Direction d = CartesianLocation::fixed(0, 0, 0).directionTowards(CartesianLocation::fixed(0, 0, 1), Vector(0, 0, 1));
...
TEST(CartesianLocation, DirectionTowardsAbove_AtPrimeMeridian) {
  Direction d = CartesianLocation::fixed(0, 0, 0).directionTowards(CartesianLocation::fixed(1, 0, 0), Vector(1, 0, 0));
  EXPECT_GE(d.getAzimuth(), -180);
  EXPECT_LT(d.getAzimuth(), 180);
  EXPECT_DOUBLE_EQ(d.getAltitude(), 90);
}
...
TEST(CartesianLocation, DirectionTowardsAbove_AtEast) {
  Direction d = CartesianLocation::fixed(0, 0, 0).directionTowards(CartesianLocation::fixed(0, 1, 0), Vector(0, 1, 0));
  EXPECT_GE(d.getAzimuth(), -180);
  EXPECT_LT(d.getAzimuth(), 180);
  EXPECT_DOUBLE_EQ(d.getAltitude(), 90);
}
...
TEST(CartesianLocation, DirectionTowardsNorth_AtPrimeMeridian) {
  Direction d = CartesianLocation::fixed(0, 0, 0).directionTowards(CartesianLocation::fixed(0, 0, 1), Vector(1, 0, 0));
...
TEST(CartesianLocation, DirectionTowardsEast_AtPrimeMeridian) {
  Direction d = CartesianLocation::fixed(0, 0, 0).directionTowards(CartesianLocation::fixed(0, 1, 0), Vector(1, 0, 0));
...
TEST(CartesianLocation, DirectionTowardsWest_AtEast) {
  Direction d = CartesianLocation::fixed(0, 0, 0).directionTowards(CartesianLocation::fixed(1, 0, 0), Vector(0, 1, 0));
  EXPECT_DOUBLE_EQ(d.getAzimuth(), -90);
  EXPECT_DOUBLE_EQ(d.getAltitude(), 0);
}

TEST(CartesianLocation, DirectionTowardsPrimeMeridian_AtEast) {
  Direction d = CartesianLocation::fixed(0, 1, 0).directionTowards(CartesianLocation::fixed(1, 0, 0), Vector(0, 1, 0));
  EXPECT_DOUBLE_EQ(d.getAzimuth(), -90);
  EXPECT_DOUBLE_EQ(d.getAltitude(), -45);
}

TEST(CartesianLocation, DirectionTowardsSouthernHemisphere_FromNorthernHemisphere) {
  Direction d = CartesianLocation::fixed(1, 1, 1).directionTowards(CartesianLocation::fixed(1, 1, -1), Vector(1, 1, 1));
  EXPECT_DOUBLE_EQ(d.getAzimuth(), -180);
...
TEST(CartesianLocation, DirectionTowardsSouthPole_FromSouthernHemisphere) {
  Direction d = CartesianLocation::fixed(1, 1, -1).directionTowards(CartesianLocation::fixed(0, 0, -1), Vector(1, 1, -1));
  EXPECT_DOUBLE_EQ(d.getAzimuth(), -180);
...
TEST(CartesianLocation, DirectionTowardsNorthWest_FromNorthernHemisphere) {
  Direction d = CartesianLocation::fixed(1, 1, 1).directionTowards(CartesianLocation::fixed(1, 0, 2), Vector(1, 1, 1));
...
TEST(CartesianLocation, DirectionTowardsSouthEast_FromSouthernHemisphere) {
  Direction d = CartesianLocation::fixed(1, 1, -1).directionTowards(CartesianLocation::fixed(0, 1, -2), Vector(1, 1, -1));
